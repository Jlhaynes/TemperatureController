...
namespace Gadgeteer.Modules.MyTemperatureProbe
{
    /// <summary>
    ...
    public class TemperatureProbe : GTM.Module
    {
        ...
        // GTM.MyTemperatureProbe.$HardwareName$. This file will provide IntelliSense and documentation for the
        ...
        public TemperatureProbe(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the TemperatureProbe is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="TemperatureProbe"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="TemperatureProbe"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="TemperatureProbe"/></param>
        public delegate void ButtonEventHandler(TemperatureProbe sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="TemperatureProbe"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="TemperatureProbe"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="TemperatureProbe"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(TemperatureProbe sender, ButtonState buttonState)
        {
